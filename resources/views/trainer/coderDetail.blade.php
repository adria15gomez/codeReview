...
@section('content')
    ...
    <button type="button"class="ease-in duration-300 text-white w-80 justify-around my-10 ml-10 bg-[#111827] hover:bg-[#111827]/80 focus:ring-4 focus:outline-none focus:ring-[#111827]/50 rounded-lg text-md py-4 inline-flex ">
        Evaluacion 2
