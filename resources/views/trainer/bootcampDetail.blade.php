...
<div class="mt-5">
    <a type="submit" value="Volver" href="{{route('trainer.promotions')}}" class="bg-black text-white text-sm font-light py-2 px-4 mt-4 rounded-lg mx-auto block w-24 text-center">Volver</a>
</div>
</div>
@endsection