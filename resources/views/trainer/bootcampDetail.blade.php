...
<img src="../img/coder/mibootcamp.svg" alt=" bootcamp"
    class="w-full h-60 sm:h-52 sm:col-span-2 md:h-80 w-100 items-center col-span-full" loading="lazy" />
...
<div class="justify-center py-10 md:items-center block text-center">
    <button type="button "
        ...
        Zoom
        <svg class="inline-flex items-center justify-end w-8 h-7 ml-52 -mr-1" aria-hidden="true" focusable="false"
    ...
    <button type="button"
        ...
        Slack
        <svg class="inline-flex items-center justify-end w-9 h-7 ml-52 -mr-1" aria-hidden="true" focusable="false"
