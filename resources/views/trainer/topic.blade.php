...
@section('content')
    <h1 class="font-medium text-4xl pt-10 ml-2 pl-2 mt-2 md:text-5xl md:flex md:justify-center">Topics</h1>
    ...
    <div class="md:flex md:justify-center">
        <button
            ...
            <a class="no-underline text-white" href="{{ route('addTopic.create') }}">
                Agregar Topic</a><svg class="flex h-7 ml-4 -mr-1 w-8 " aria-hidden="true" focusable="false" data-prefix="fab"
    ...
    <p class=" font-medium text-2xl text-left mt-10 ml-10 mb-5 md:flex md:justify-center">Lista de Topics</p>
    ...
    @foreach ($topics as $topic)
        ...
        <div id="accordion-collapse" data-accordion="collapse" class="mb-6">
            <h2 id="accordion-collapse-heading-1">
                <button type="button"
                    class="flex items-center justify-between w-72 p-4 ml-10 bg-gray-900 font-medium text-left text-white border border-b-0 border-gray-200 rounded-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800"
                    data-accordion-target="#accordion-collapse-body-1" aria-expanded="true"
                    aria-controls="accordion-collapse-body-1">
                    {{ $topic->name }}
                    <svg data-accordion-icon class="w-6 h-6 rotate-180 shrink-0" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd"d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"clip-rule="evenodd"></path>
                    </svg>
                </button>
            </h2>
            <div id="accordion-collapse-body-1" class="hidden bg-gray-900 w-72 ml-10 rounded-xl mt-1"
                aria-labelledby="accordion-collapse-heading-1">
                <div class="flex justify-center items-center">
                    <a class="no-underline text-white" href="{{ route('editTopic.edit', $topic) }}">Editar</a>
