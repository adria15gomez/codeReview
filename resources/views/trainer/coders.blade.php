...
@section('content')
  <div>
    <div class="flex flex-col mt-2 py-8 px-2 md:items-center">
        <h1 class="font-bold text-5xl pt-0 ml-2 pl-2 md:text-5xl">Hola</h1>
        <h1 class="font-normal text-5xl pt-0 ml-2 pl-2 md:text-5xl">Formador</h1>
...
<div class="md:w-6/12 p-6 ">
        <h3 class="font-medium text-2xl py-8 ml-10 md:flex md:justify-center">Lista de coders</h3>

        <div class="max-w-sm md:flex md:align-center p-6 mx-5 border ml-10 mt-0.5 border-gray-200 rounded-lg shadow bg-[#111827]">
        ...
        <button type="button"
            class="text-white w-5/6 justify-around text-base my-10  ml-10 bg-[#111827] hover:bg-[#111827]/80 focus:ring-4 focus:outline-none focus:ring-[#111827]/50 rounded-lg text-md py-4 px-2  text-center inline-flex items-center">
            Sergio González
            <svg class="flex h-7 ml-4 -mr-1 w-8" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="arrow"
                role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="currentColor"
