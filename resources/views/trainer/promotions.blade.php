...
<div class="flex flex-col items-center justify-center">
    ...
    <h3 class="font-regular text-xl mt-5 text-center">Lista de bootcamps</h3>
    ...
    <div class="flex flex-wrap justify-center gap-5 px-3">
        ...
        <div class="max-w-sm p-6 mx-5 border ml-10 mt-4 border-gray-200 rounded-lg shadow bg-[#111827] flex flex-col">
            ...
            <div class="flex">
                <a href="{{route('promotions.show', ['promotion' => $promotion->id])}}" class="flex-row text-white mr-4 cursor-pointer">Ver</a>
                <span class="mx-4 text-white">|</span>
                <a href="{{route('editPromotion.edit', ['promotion' => $promotion->id])}}"
                    class=" flex-row text-white mr-4 cursor-pointer">Editar</a>
                <span class="mx-4 text-white">|</span>
