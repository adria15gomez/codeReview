...
@section('content')
    <div class="flex flex-col items-center justify-center">
        <h1 class="font-regular text-5xl text-left mt-5">Competencias</h1>
        <img src="../img/admin/competencias.svg" class="mx-auto lg= scale-125 pt-10 h-50 xl:h-80" alt="competencias" />
        <a class="text-white w-72 justify-center text-base my-12 bg-orange-600 hover:bg-orange-600/80 focus:ring-4 focus:outline-none focus:ring-[orange-600]/50 rounded-lg  px-0.5 py-4 inline-flex"
        ...
        <p class="font-regular text-xl py-4">Lista de competencias</p>
