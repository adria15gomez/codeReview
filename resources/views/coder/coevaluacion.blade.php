...
@section('content')
    ...
    <div class="flex justify-center mb-8">
        <p class="md:w-5/12 text-justify">Estás a punto de realizar una coevaluación, elige a tu compañero y selecciona el nivel en el que consideras se encuestra en cada habilidad.<br>
