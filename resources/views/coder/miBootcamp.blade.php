...
@section('content')
  ...
  <div class="flex flex-col items-center justify-center">
    ...
    <div class="flex-col gap-3 mt-10">
      ...
      <a type="button" href="{{$promotions->zoom_url}}" target="_blank" class="flex justify-between items-center text-white bg-gray-900 w-72 h-12 mb-5 px-4 rounded-xl hover:bg-black">
        Zoom
      ...
      <a type="button" href="{{$promotions->slack_url}}" target="_blank" class="flex justify-between items-center text-white bg-orange-600 w-72 h-12 px-4 rounded-xl hover:bg-black">
        Slack
