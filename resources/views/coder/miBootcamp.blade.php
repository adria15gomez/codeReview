...
@section('content')
        ...
        <div class="flex flex-col  mt-2 py-8 px-2 md:items-center">
            <h1 class="font-regular text-3xl pt-0 ml-2 pl-2 xl:text-3xl">Mi bootcamp</h1>
        ...
        <img src="img/coder/mibootcamp.svg"
            alt=" bootcamp"class="w-full h-60 sm:h-52 sm:col-span-2 md:h-80 w-100 items-center col-span-full xl:h-80" loading="lazy" 
        />

    @foreach ($promotions as $promotion)
        <div class="mr-5 mt-2 py-2 px-2 ml-10 md:ml-50 pb-10 md:justify-center xl:text-center">            
    ...
    <h3 class="font-regular text-xl px-10 pb-2 pt-2 xl:text-center">Lista de Topics</h3>
    @foreach ($competences as $competence)
    <div class="mt-2 py-2 px-2 xl:text-center">
    ...
    <div class="mt-2 items-center px-2 xl:flex justify-center">
