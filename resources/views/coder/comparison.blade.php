...
@section('content')
    ...
    <div class="flex justify-center mb-4">
        <p class="font-regular text-lg text-left mt-5 ml-10 mb-5 md:w-2/4 md:text-justify">En este apartado, puedes comparar la percepción de tus
            habilidades con la opinión de tu compañero. De izquierda a derecha, la escala cubre desde "Saber investigar" hasta
            "Saber crear". <strong>¡Mira tu evolución con otros ojos!</strong>
        </p>
    </div>
