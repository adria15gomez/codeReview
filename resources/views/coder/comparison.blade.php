...
<div class="flex flex-col items-center justify-center px-5">
    ...
    <div class="flex justify-center mb-4">
        <p class="max-w-lg text-base text-center">En este apartado, puedes comparar la percepción de tus
            habilidades con la opinión de tu compañero. De izquierda a derecha, la escala cubre desde "Saber investigar" hasta
            "Saber crear".<br><span class="font-semibold">¡Mira tu evolución con otros ojos!</span>
        </p>
    </div>
        ...
        <div class="ratingGroup mt-5">
            ...
            <div class="ratingGroup mt-5">
                <div class="flex max-w-sm justify-between md:gap-2 xl:gap-3">
                    ...
                    <label for="{{$auto->name}}-rating-2" class="{{ $auto->level === 2 ? 'opacity-100' : 'cara' }}" title="Saber Recordar"><img src="/img/coder/2cara.svg" alt="Saber Recordar"/></label>
